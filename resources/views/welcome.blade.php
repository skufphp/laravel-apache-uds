        ...
        <div class="content-panel">
            <div class="section">
                ...
                <div class="stack-grid">
                    ...
                    <div class="stack-item">
                        <div class="stack-icon orange">A</div>
                        <span>Apache FastCGI</span></div>
                    <div class="stack-item">
...
<footer class="site-footer">
    Laravel + PHP-FPM + Apache over Unix Socket · <a href="https://www.php.net/manual/en/install.fpm.php"
                                                     class="footer-link">php.net/manual/en/install.fpm.php</a>
</footer>
</body>
</html>
