...
<head>
    ...
    <title>Laravel · PHP-FPM · Apache · Unix Socket</title>
        ...
        <div class="content-panel">
            <div class="section">
                ...
                <div class="stack-grid">
                    ...
                    <div class="stack-item"><div class="stack-icon orange">A</div><span>Apache FastCGI</span></div>
            ...
            <div class="section">
                ...
                <div class="services-list">
                    <div class="service-row">
                        ...
                        <span class="service-name">Apache · PHP-FPM · Unix Socket</span>
...
<footer class="site-footer">
    Laravel + PHP-FPM + Apache over Unix Socket · <a href="https://www.php.net/manual/en/install.fpm.php" class="footer-link">php.net/manual/en/install.fpm.php</a>
</footer>
</body>
</html>
